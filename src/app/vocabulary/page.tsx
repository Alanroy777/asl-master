...
import { getVocabularyStats } from "@/app/lib/actions"
import VocabularyDashboard from "@/components/vocabulary/vocabulary-dashboard"
        ...
        <div className="max-w-6xl mx-auto space-y-8 p-4 md:p-8">
            ...
            <div className="flex flex-col gap-2">
                ...
                <p className="text-muted-foreground">
                    Track your long-term memory and review signs using spaced repetition.
                </p>
            </div>
